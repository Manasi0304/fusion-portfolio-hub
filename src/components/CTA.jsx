...
const CTA = () => {
  return (
    <div className="bg-primary/5 py-16 border-t border-border">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <CustomButton to="/contact" size="large" className="btn-hover-effect">
            Get in Touch
          </CustomButton>
          <CustomButton variant="outline" href="/resume.pdf" size="large" className="btn-hover-effect">
            View My Resume
          </CustomButton>
        </div>
      </div>
